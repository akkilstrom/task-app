<svg version="1.1" width="36" height="36"  viewBox="0 0 36 36" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	...
	<path class="clr-i-outline clr-i-outline-path- icon" 
	...
	<path class="clr-i-outline clr-i-outline-path-4 icon" 
	...
	<path class="clr-i-outline clr-i-outline-path-5 icon" 
	...
	<path class="clr-i-outline clr-i-outline-path-6 icon" 
